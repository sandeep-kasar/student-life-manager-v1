...
/**
 * Created by Owner on 15/04/2017.
 */

public class MyExpenseAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //get activity object
    MyExpenseFragment myExpenseFragment;
     ...
     *
     * @param context
     * @param myExpenseFragment
     * @param objectList
     */
    public MyExpenseAdapter(Context context, MyExpenseFragment myExpenseFragment, List<Object> objectList) {
        this.context = context;
        this.myExpenseFragment = myExpenseFragment;
    ...
    public int getItemViewType(int position) {
        ...
        if (object instanceof ExpHeaderObj) return EXP_HEADER;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (viewType) {
            ...
            case EXP_HEADER:
                ExpHeaderHol exp_header = (ExpHeaderHol) holder;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) { //EXP_HEADER
            ...
            //get EXP_HEADER view
            View view_exp_header = layoutInflater.inflate(R.layout.layout_exp_header, parent, false);

            //init view
            viewHolder = new ExpHeaderHol(view_exp_header);
     ...
     * @param position
     */
    public void retriveExpHeader(final ExpHeaderHol expHeaderHol, int position) {

        //get object data
        final ExpHeaderObj expHeaderObj = (ExpHeaderObj) objectList.get(position);
        //set balance
        ...
        expHeaderHol.tv_bal_remain.setText("Rs." + Integer.toString(expHeaderObj.getBalance_total()));
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!amount.equals("") || !source.equals("") || !note.equals("")) {
                    ...
                    //notify adapter
                    //set data
                    myExpenseFragment.setData();

                    //show message
                    Toast.makeText(myExpenseFragment.getActivity(), "Edited successfully.", Toast.LENGTH_LONG).show();
