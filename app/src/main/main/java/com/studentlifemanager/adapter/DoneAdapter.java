...
public class DoneAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //static var
    static final int TODO_DATE = 0, TODO_TASK = 1;
     ...
     * @param objectList
     */
    public DoneAdapter(Context context, DoneFragment doneFragment1, List<Object> objectList) {
        this.context = context;
        this.doneFragment = doneFragment1;
    ...
    public int getItemViewType(int position) {
        ...
        if (object instanceof TodoDateObj) return TODO_DATE;
        else if (object instanceof ToDoTaskObj) return TODO_TASK;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) { //EXP_HEADER
            ...
            //get EXP_HEADER view
            View view = layoutInflater.inflate(R.layout.layout_done_task, parent, false);
    ...
    public void retriveToDoTask(final ToDoTaskHol toDoTaskHol, final int position) {
        ...
        toDoTaskHol.img_menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                popup.inflate(R.menu.menu_done_list);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!task.equals("")) {
                    ...
                    //add data in database
                    myTaskOperation.updateTask(id,task, newDate
                            , time);
                    ...
                    //init adapter
                    doneFragment.doneAdapter = new DoneAdapter(context, doneFragment, objectList);

                    //set adapter to rv
                    doneFragment.recycler_view.setAdapter(doneFragment.doneAdapter);

                    //notify adapter
                    doneFragment.doneAdapter.notifyDataSetChanged();

                    //Toast.makeText(doneFragment.getActivity(),"Edited successfully.",Toast.LENGTH_LONG).show();

                    Snackbar snackbar = Snackbar.make(doneFragment.coordinatorLayout, "Edited successfully.", Snackbar.LENGTH_LONG);
                    snackbar.show();
                    //dismiss dialog
                    dialog.dismiss();
                }
    ...
    public void getTime() {
        ...
        TimePickerDialog tpd = new TimePickerDialog(context, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int i, int i1) {
                ...
                edt_time.setText(DoneFragment.formateTimeFromstring("HH:mm", "h:mm a", time));
